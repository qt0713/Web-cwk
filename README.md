...
- Source Markdown: `docs/API_DOCUMENTATION.md`
- For submission, export to PDF and reference the generated PDF in this README.
...
Use of GenAI must be declared. See `TECHNICAL_REPORT.md` section "Generative AI Declaration" and include conversation log excerpts in supplementary material.
